...
alter table public."Team Data"
  drop constraint if exists team_data_email_not_blank;

alter table public."Team Data"
  add constraint team_data_email_not_blank check (normalized_email <> '');

create unique index if not exists team_data_normalized_email_key
  on public."Team Data" (normalized_email);
