...
export function updateMemberProfile(token: string, input: Pick<MemberProfile, "firstName" | "middleName" | "lastName" | "phone" | "address" | "birthMonth" | "birthDay" | "churchJoinYear">) {
