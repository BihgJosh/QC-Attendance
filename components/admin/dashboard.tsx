    ...
    <div className="min-h-screen relative z-10">
      ...
      <div className="border-b border-border/40 bg-background/75 backdrop-blur">
        <div className="mx-auto flex max-w-7xl gap-2 overflow-x-auto px-4 py-3 sm:px-6 lg:px-8" role="tablist" aria-label="Admin sections">
          ...
          {isContentAdmin && <Button type="button" size="sm" variant={adminView === "passwords" ? "gradient" : "ghost"} role="tab" aria-selected={adminView === "passwords"} onClick={() => setAdminView("passwords")}><KeyRound className="mr-2 h-4 w-4" />Password resets</Button>}
