...
type ActivityUser = { name: string; email: string; total: number; lastSubmittedAt: string; reportTypes: Record<string, number>; identity?: MemberIdentity };
