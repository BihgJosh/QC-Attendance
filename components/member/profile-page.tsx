        ...
        <div className="space-y-6">
          <form onSubmit={save} className="overflow-hidden rounded-2xl bg-card shadow-[var(--surface-shadow)]">
            ...
            <div className="space-y-8 px-5 py-6 sm:px-8 sm:py-8">
              ...
              <section aria-labelledby="address-heading"><h3 id="address-heading" className="text-base font-bold">Address</h3><div className="mt-4"><Field label="What is your residential address?" id="address"><Input id="address" autoComplete="street-address" value={profile.address} onChange={(event) => set("address", event.target.value)} maxLength={300} placeholder="Enter your full residential address" required /></Field></div></section>
              ...
              <section aria-labelledby="church-history-heading"><h3 id="church-history-heading" className="text-base font-bold">Church history</h3><div className="mt-4 max-w-md"><Field label="When did you join Streams of Joy Abuja?" id="church-join-year"><Input id="church-join-year" type="number" inputMode="numeric" min="1900" max={new Date().getFullYear()} step="1" value={profile.churchJoinYear ?? ""} onChange={(event) => set("churchJoinYear", event.target.value ? Number(event.target.value) : null)} placeholder="e.g. 2020" required /></Field></div></section>
            </div>
