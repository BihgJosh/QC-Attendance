...
type Profile = { email: string; firstName: string; middleName: string; lastName: string; phone: string; birthMonth: number | null; birthDay: number | null; qcJoinDate: string; avatarUrl: string | null; role: Role; profileComplete: boolean };
        ...
        <div className="space-y-6">
          <form onSubmit={save} className="overflow-hidden rounded-2xl bg-card shadow-[var(--surface-shadow)]">
            ...
            <div className="space-y-8 px-5 py-6 sm:px-8 sm:py-8">
              ...
              <section aria-labelledby="qc-history-heading"><h3 id="qc-history-heading" className="text-base font-bold">Quality Control history</h3><div className="mt-4 max-w-md"><Field label="When did you join Quality Control?" id="qc-join-date"><Input id="qc-join-date" type="date" value={profile.qcJoinDate} onChange={(event) => set("qcJoinDate", event.target.value)} max={new Date().toISOString().slice(0, 10)} required /></Field></div></section>
            </div>
