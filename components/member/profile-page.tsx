...
type Profile = { email: string; firstName: string; middleName: string; lastName: string; phone: string; birthMonth: number | null; birthDay: number | null; churchJoinYear: number | null; avatarUrl: string | null; role: Role; profileComplete: boolean };
