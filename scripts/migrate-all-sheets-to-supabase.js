...
function normalizeTimer(record) {
  const segmentLabels = ["Opening Prayer", "Praise & Worship", "Speaking into the Week", "Solo Ministration", "Declaration", "First Testimony", "Second Testimony", "Third Testimony", "Choir Ministration", "Pastor's Ministration", "Offering & Announcement"];
