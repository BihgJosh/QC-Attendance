...
body.push(
  ...
  bullet("An Admin or Super Admin role on your member account if you manage the platform."),
  ...
  callout("Security reminder", "Never share your private password. Do not include Service Manager passwords in screenshots, messages or this document.", "warn"),
  pageBreak(),
  ...
  p("Only members assigned the Admin or Super Admin role can see and open the administrator dashboard."),
  step("Sign in", "Use your own member email and private password. There is no shared administrator password."),
  step("Open Admin", "Select Admin dashboard from Home or your profile. The option is hidden for every other role."),
